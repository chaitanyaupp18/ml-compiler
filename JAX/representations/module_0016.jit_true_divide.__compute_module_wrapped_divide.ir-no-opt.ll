; ModuleID = '__compute_module___compute_module_wrapped_divide'
source_filename = "__compute_module___compute_module_wrapped_divide"
...
define ptr @wrapped_divide(ptr %0) {
...
19:                                               ; preds = %16
  call void @wrapped_divide_impl(ptr %5, ptr %5, i64 0, ptr %7, ptr %7, i64 0, ptr %9, ptr %9, i64 0, i64 %17)
  %20 = add i64 %17, 1
  br label %16
...
define internal void @wrapped_divide_impl(ptr %0, ptr %1, i64 %2, ptr %3, ptr %4, i64 %5, ptr %6, ptr %7, i64 %8, i64 %9) #0 {
  %11 = alloca float, i64 1, align 4
  %12 = getelementptr float, ptr %1, i64 %2
  ...
  %17 = fdiv float %13, %16
  %18 = alloca float, i64 1, align 64
  store float %17, ptr %18, align 4
  %19 = getelementptr float, ptr %7, i64 %8
  call void @llvm.memcpy.p0.p0.i64(ptr %19, ptr %18, i64 4, i1 false)
  ret void
}
