...
define noalias noundef ptr @wrapped_divide(ptr nofree readonly captures(none) %0) local_unnamed_addr #0 {
...
.lr.ph:                                           ; preds = %1
  ...
  %13 = load float, ptr %12, align 1
  %14 = load float, ptr %11, align 1
  %15 = fdiv float %13, %14
  store float %15, ptr %9, align 1
  br label %16
