; ModuleID = '__compute_module_slice_add_fusion.1_kernel_module'
source_filename = "__compute_module_slice_add_fusion.1_kernel_module"
...
define ptr @slice_add_fusion.1(ptr %0) #0 {
  ...
  call void @slice_add_fusion.1_wrapped(ptr %5, ptr %7, ptr %9, i64 %13, i64 %15, i64 %17)
  ret ptr null
}

; Function Attrs: alwaysinline
define internal void @slice_add_fusion.1_wrapped(ptr noalias align 64 dereferenceable(8) %0, ptr noalias align 64 dereferenceable(4) %1, ptr noalias align 64 dereferenceable(4) %2, i64 %3, i64 %4, i64 %5) #1 {
  %7 = getelementptr inbounds [2 x i32], ptr %0, i32 0, i32 0
