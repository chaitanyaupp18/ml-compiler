...
define internal void @broadcast_add_fusion_wrapped(ptr noalias align 64 dereferenceable(4) %0, ptr noalias align 64 dereferenceable(16) %1, ptr noalias align 64 dereferenceable(80) %2, ptr noalias align 64 dereferenceable(80) %3, ptr noalias align 64 dereferenceable(4) %4, ptr noalias align 64 dereferenceable(80) %5, i64 %6, i64 %7, i64 %8) #1 {
...
43:                                               ; preds = %40
  ...
  %45 = getelementptr inbounds [20 x i32], ptr %2, i32 0, i64 %44
  %46 = load i32, ptr %45, align 4, !invariant.load !3
  %47 = shl i32 %46, %11
  %48 = select i1 %13, i32 %47, i32 0
  %49 = lshr i32 %46, %12
  %50 = select i1 %14, i32 %49, i32 0
  %51 = getelementptr inbounds [20 x i32], ptr %3, i32 0, i64 %44
  ...
  %77 = add i32 %76, %31
  %78 = add i32 %77, %34
  %79 = getelementptr inbounds [20 x i32], ptr %5, i32 0, i64 %44
