...
define internal void @broadcast_add_fusion_wrapped(ptr noalias align 64 dereferenceable(120) %0, ptr noalias align 64 dereferenceable(40) %1, ptr noalias align 64 dereferenceable(120) %2, i64 %3, i64 %4, i64 %5) #1 {
  br label %7
...
15:                                               ; preds = %12
  ...
  %17 = getelementptr inbounds [30 x float], ptr %0, i32 0, i64 %16
  %18 = load float, ptr %17, align 4, !invariant.load !3
  %19 = getelementptr inbounds [10 x float], ptr %1, i32 0, i64 %13
  %20 = load float, ptr %19, align 4, !invariant.load !3
  %21 = fadd float %18, %20
  %22 = getelementptr inbounds [30 x float], ptr %2, i32 0, i64 %16
