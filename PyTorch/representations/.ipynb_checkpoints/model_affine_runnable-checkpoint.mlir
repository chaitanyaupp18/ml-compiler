// Auto-generated kernel from representations/mlir_linalg-on-tensors.mlir
// (real torch weights inlined; bufferized; results->out-param; linalg->affine).
// C-callable bare-ptr ABI:  void model(float *in, float *out)
module {
  ...
  func.func @model(%arg0: memref<3x5xf32>, %arg1: memref<3x2xf32>) {
